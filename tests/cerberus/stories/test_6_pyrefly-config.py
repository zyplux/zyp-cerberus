...
from cerberus.checks import pyrefly_config_check
from cerberus.model import CheckResult, Finding, Repo, Status

RunPyrefly = Callable[..., CheckResult]
...
@pytest.fixture
def run_pyrefly(monkeypatch: pytest.MonkeyPatch, repo: Repo, ctx: context.Context) -> RunPyrefly:
    def run(
        *,
        ...
        return pyrefly_config_check.run(repo, ctx)
