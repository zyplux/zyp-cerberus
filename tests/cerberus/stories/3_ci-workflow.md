# 3. [Requiring a working ci workflow](test_3_ci-workflow.py)
...
### 3.3.2 passes with a pull request trigger

### 3.3.3 passes with a pull request target trigger

### 3.3.4 passes when the on key parses to a boolean
