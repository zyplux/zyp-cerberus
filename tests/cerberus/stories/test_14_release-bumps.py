...
def test_14_1_3_errors_when_the_manifest_has_no_target_array(run_release_bumps: RunReleaseBumps) -> None:
...
def test_14_2_3_fails_when_no_version_is_found_in_the_version_file(
    run_release_bumps: RunReleaseBumps, manifest: str, version_file_content: str
) -> None:
...
def test_14_2_5_reads_the_version_via_the_target_regex(run_release_bumps: RunReleaseBumps) -> None:
...
def test_14_3_3_errors_when_the_published_tags_cannot_be_read(run_release_bumps: RunReleaseBumps) -> None:
    result = run_release_bumps(tags=GitHistoryUnavailableError("git tag failed"))
...
def test_14_5_3_errors_when_the_surface_diff_cannot_be_computed(run_release_bumps: RunReleaseBumps) -> None:
    result = run_release_bumps(tags=["widget-v0.1.0"], changed=GitHistoryUnavailableError("git diff failed"))
