...
### 4.1.1 flags a parent import at any depth

### 4.1.2 flags a type only import from a parent path

### 4.1.3 flags a re export from a parent path

## 4.2 permitting non-parent-relative import specifiers

### 4.2.1 allows a same directory relative import

### 4.2.2 allows alias and bare package imports
